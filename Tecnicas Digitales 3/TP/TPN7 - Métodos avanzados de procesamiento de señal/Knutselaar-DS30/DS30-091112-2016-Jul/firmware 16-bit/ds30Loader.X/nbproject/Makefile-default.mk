...
MP_LINKER_FILE_OPTION=--script="D:\\Program\\Microchip\\MPLAB ASM30 Suite\\Support\\dsPIC33F\\gld\\p33FJ256GP710A.gld"
# ------------------------------------------------------------------------------------
...
${OBJECTDIR}/_ext/1360937237/ds30loader.o: ../src/ds30loader.s  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/ds30loader.o.d" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE)  ../src/ds30loader.s -o ${OBJECTDIR}/_ext/1360937237/ds30loader.o -omf=elf -p=$(MP_PROCESSOR_OPTION) --defsym=__DEBUG=1 --defsym=__MPLAB_DEBUGGER_ICD3=1 -g -I"../src" -MD "${OBJECTDIR}/_ext/1360937237/ds30loader.o.d" 
...
${OBJECTDIR}/_ext/1360937237/ds30loader.o: ../src/ds30loader.s  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/1360937237/ds30loader.o.d 
	@${RM} ${OBJECTDIR}/_ext/1360937237/ds30loader.o.ok ${OBJECTDIR}/_ext/1360937237/ds30loader.o.err 
	@${FIXDEPS} "${OBJECTDIR}/_ext/1360937237/ds30loader.o.d" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE)  ../src/ds30loader.s -o ${OBJECTDIR}/_ext/1360937237/ds30loader.o -omf=elf -p=$(MP_PROCESSOR_OPTION) -I"../src" -MD "${OBJECTDIR}/_ext/1360937237/ds30loader.o.d" 
...
dist/${CND_CONF}/${IMAGE_TYPE}/ds30Loader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_LD} $(MP_EXTRA_LD_PRE)  ${OBJECTFILES_QUOTED_IF_SPACED}    -omf=elf $(MP_LINKER_FILE_OPTION) --defsym=__MPLAB_DEBUG=1 --defsym=__MPLAB_DEBUGGER_ICD3=1 --defsym=__ICD2RAM=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/ds30Loader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} 
else
dist/${CND_CONF}/${IMAGE_TYPE}/ds30Loader.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
