...
plot(fd, y1(1 : (K/2)))
grid on
title('Espectro de la señal filtrada con registro de desplazamientos.')
...
grid on
title('Espectro de la señal filtrada con función filter.')
xlim([0 128])
text(10, -30,strcat(strcat('Amplitud en 50Hz:',num2str(amp_50Hz)),'dB'))
text(10, -33,strcat(strcat('Amplitud en 100Hz:',num2str(amp_100Hz)),'dB'))
xlabel('Frecuencia [Hz]')
...
grid on
xlim([0 128])
text(50,-30.70098,'X Atenuación en 50Hz')
text(100,-34.0427,'X Atenuación en 100Hz')
