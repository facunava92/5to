...
extern fractional temp[32] __attribute__((space(dma)));
extern FIRStruct mi_filtro;
...
//Chequeo cual banco de memoria RAM esta empleando el DMA0,  A == 0 o el B == 1
if(DMACS1bits.PPST2 == 1)                               
    FIR(32, temp, (fractional *)Data_ADC_BufferA, &mi_filtro);
else
    FIR(32, temp, (fractional *)Data_ADC_BufferB, &mi_filtro);
...
//Chequeo cual banco de memoria RAM esta empleando el DMA1,  A == 0 o el B == 1
if(DMACS1bits.PPST0 == 1)
    VectorCopy(32, (fractional *) Data_DAC_BufferA, temp);
else
    VectorCopy(32, (fractional *) Data_DAC_BufferB, temp); 
}
