...
\begin{axis}[
	xmin=-5, xmax=20,
	ymin=-23.1, ymax=-12,
	xtick={0,5.6,10,15,20},
	ytick={-14.9305,-13.886, -12, -16, -18, -20, -22},
    xlabel=Potencia del puerto IF,    
    ylabel=Potencia del Oscilador Local,
...
\begin{axis}[
	xmin=-5, xmax=20,
	ymin=-23.1, ymax=-5,
	xtick={0,5,10,13,15,20},
	ytick={-8.58248,-7.571428571, -12, -14, -16, -18, -20, -22},
    xlabel=Potencia del puerto IF,    
    ylabel=Potencia del Oscilador Local,
    legend pos=south east,
    grid=major,
	...
	\addplot [red] 	table[x=LO,y=ideal] {tablas/CPL2.txt};  
	\addplot [blue] table[x=LO,y=RF] 	{tablas/CPL2.txt};
	\addplot[solid,
			mark=*, 
			mark options={solid,fill=yellow!80!black,draw=black, scale=0.5},
			black] 
			coordinates {(13,-7.571428571) (13,-8.58248)};

	\path [draw=gray, dashed, thick] (13,-8.58248) -- (13,-23);
	\path [draw=gray, dashed, thick] (13,-8.58248) -- (-6,-8.58248);
	\path [draw=gray, dashed, thick] (13,-7.571428571)  -- (-6,-7.571428571);
	
	\draw [decorate, decoration={brace,amplitude=2pt,raise=1pt}] (13,-7.571428571)  -- (13,-8.58248) node [midway, anchor=south west,yshift=-1mm, outer sep=1pt,font=\tiny]{1dB};
...
\begin{axis}[
	xmin=-5, xmax=20,
	ymin=-12, ymax=-3,
	xtick={0,2.6,5,10,15,20},
	ytick={-4.44354,-5.48021, -12, -14, -16, -18, -20, -22},
    xlabel=Potencia del puerto IF,    
    ylabel=Potencia del Oscilador Local,
    legend pos=south east,
    grid=major,
...
\end{axis}
\end{tikzpicture}
	\caption{Perdida por compresión de mezclador de balanceo doble
	}
\end{figure}
