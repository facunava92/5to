...
\usepackage{geometry}
 \geometry{a4paper,total={170mm,257mm},left=10mm,right=10mm,top=15mm,bottom=18mm}
\usepackage{hyperref} 
...
\begin{axis}[
  ...
  \addplot [red] table [x=LO,y=RF] {tablas/CPL1.txt};
  \addplot [blue] table[x=LO,y=ideal] {tablas/CPL1.txt};
\end{axis}
\end{tikzpicture}
